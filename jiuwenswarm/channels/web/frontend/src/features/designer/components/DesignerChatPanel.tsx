import { Expand, Loader2, SendHorizontal, Shrink } from 'lucide-react';
import {
  useCallback,
  useEffect,
  useRef,
...
export function DesignerChatPanel() {
  ...
  }, [chatBusy, draft, loadProjects, selectedProject?.project_id, t, workMode]);
  ...
  return (
    ...
    >
      <div className="designer-chat-panel__header">
        ...
        >
          {chatCollapsed ? <Expand size={16} aria-hidden /> : <Shrink size={16} aria-hidden />}
        </button>
      </div>
      {!chatCollapsed ? (
        <>
